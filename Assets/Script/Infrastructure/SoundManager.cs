...
public class SoundManager : SingletonBehaviour<SoundManager>
{
    ...
    public static void ChangeMasterVolume(float val) => Instance.MasterVolume = val;
    public static void ChangeBgmVolume(float val) => Instance.BgmVolume = val;
    public static void ChangeVfxVolume(float val) => Instance.VfxVolume = val;
}